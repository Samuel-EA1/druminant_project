...
export default function Help() {
  ...
  const handleRotate = (tabIndex) => (
    openTab === tabIndex ? 'rotate-180' : ''
  );
          ...
          {[{
            ...
            <li key={index} className="bg-white my-2 shadow-lg">
              ...
              >
                ...
                <svg
                  className={`fill-current text-green-700 h-6 w-6 transform transition-transform duration-500 ${handleRotate(index)}`}
                  viewBox="0 0 20 20"
                >
              ...
              >
                <p className="p-3 bg-gray-50  text-gray-900">
                  {item.answer}
                </p>
              </div>
            </li>
