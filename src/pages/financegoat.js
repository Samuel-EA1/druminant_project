...
function FinanceRecord() {
    ...
    function editBtnFn(entryDate){
        ...
        setEditIncomeForm(selectedRecord[0])
      }



      const handleEditFormSubmit = (e, entryDate) => {
        const newincomeData = incomeData.map((row) => {
          if(row.entryDate === entryDate){
            console.log("testin")
            return row = editIncomeForm ;
          }
          return row  
        })
    ...
    //         incomeInput.transactionDate &&
    //         incomeInput.amount &&
    //         incomeInput.payMethod &&
    //         incomeInput.remark &&
    //         incomeInput.staff
    //     );
    // };
                        ...
                        {expenseData.map((row2, key) => (
                            ...
                            >
                                ...
                                <td className="w-full md:w-auto flex justify-between items-center p-3  border-green-200 text-gray-800  border border-b text-center blockryur md:table-cell relative md:static ">
                                    ...
                                    <div className="">
                                        <button title="Edit" onClick={() => editBtnFn(row.tagId)} className=" px-2 py-1 hover:bg-blue-600 text-white bg-blue-500 rounded-md">
                    ...
                    <div class="w-[auto] relative mt-6 py-8 px-5 md:px-10  shadow-md rounded border border-green-700">
                        <form onSubmit={handleIncomeSubmit}>
                            ...
                            <div>
                                ...
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." value={incomeInput.description} onChange={handleChange} name="description" placeholder="E.g. Sales of animal" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                ...
                                <input title="in Naira" type="number" value={incomeInput.amount} onChange={handleChange} name="amount" id="breed" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border"   maxLength={5} required />
                                <label className="input-label" htmlFor="payMethod" >Payment method</label>
                                <select id="name" value={incomeInput.payMethod} onChange={handleChange} name="payMethod" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required>
                                ...
                                <input value={incomeInput.staff} onChange={handleChange} name="staff" placeholder="enter your name" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                ...
                <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-xl">
                    <div class="w-[auto] relative mt-6 py-8 px-5 md:px-10  shadow-md rounded border border-green-700">
                        <form onSubmit={handleExpenseSubmit}>
                            ...
                            <div>
                                <label className="input-label" htmlFor="description" >Description</label>
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." value={expenseInput.description} onChange={handleChange2} name="description" placeholder="E.g. Sales of animal" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="transactionDate" >Transaction Date</label>
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." type="date" value={expenseInput.transactionDate} onChange={handleChange2} name="transactionDate" id="breed" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="amount" >Amount</label>
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." maxLength={5} type="number" value={expenseInput.amount} onChange={handleChange2} name="amount" id="breed" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="payMethod" >Payment method</label>
                                <select id="name" value={expenseInput.payMethod} onChange={handleChange2} name="payMethod" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required>
                                    <option value={""}>Select payment method</option>
                                    <option>Cash</option>
                                    <option>Transfer</option>
                                    <option>Cheque</option>
                                ...
                                <label className="input-label" htmlFor="remark">Remark</label>
                                <input value={expenseInput.remark} onChange={handleChange2} name="remark" placeholder="give additional information here." type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="staff" >Staff-in-charge of entry</label>
                                <input value={expenseInput.staff} onChange={handleChange2} name="staff" placeholder="enter your name" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                ...
                <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-xl">
                    <div class="w-[auto] relative mt-6 py-8 px-5 md:px-10  shadow-md rounded border border-green-700">
                        <form onSubmit={handleIncomeSubmit}>
                            ...
                            <div>
                                <label className="input-label" htmlFor="description" >Description</label>
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." value={editIncomeForm.description} onChange={handleChange} name="description" placeholder="E.g. Sales of animal" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="transactionDate" >Transaction Date</label>
                                <input title="Enter the breed of the livestock (e.g., Angus, Holstein) here." type="date" value={editIncomeForm.transactionDate} onChange={handleChange} name="transactionDate" id="breed" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" lFor="amount" >Amount</label>
                                <input title="in Naira" type="number" value={editIncomeForm.amount} onChange={handleChange} name="amount" id="breed" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="payMethod" >Payment method</label>
                                <select id="name" value={editIncomeForm.payMethod} onChange={handleChange} name="payMethod" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required>
                                    <option value={""}>Select payment method</option>
                                    <option>Cash</option>
                                    <option>Transfer</option>
                                    <option>Cheque</option>
                                ...
                                <label className="input-label" htmlFor="remark">Remark</label>
                                <input value={editIncomeForm.remark} onChange={handleChange} name="remark" placeholder="give additional information here." type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />
                                <label className="input-label" htmlFor="staff" >Staff-in-charge of entry</label>
                                <input value={editIncomeForm.staff} onChange={handleChange} name="staff" placeholder="enter your name" type="text" id="description" class="mb-5 mt-2 text-gray-800 focus:outline-none focus:border focus:border-gray-500 font-normal w-full h-10 flex items-center pl-1 text-sm border-gray-400 rounded border" required />

                            </div>


                            <div className="form-btns" >
                                <button className="btn" type="submit" onClick={(e) => handleEditFormSubmit(e, editEntryDate )} >Submit</button>
