...
function LivestockSelection() {
    ...
    return <div>
        <Head>
            <title>Druminant - Pregnancy Checker</title>
        ...
        <div>
            ...
            <div className="dashboard-main  mx-auto">
                <h1 className=" text-white mt-5 text-center md:mt-16" style={{ fontFamily: "verdana", fontWeight: "bold", fontSize: "20px" }}>Pregnancy Checker</h1>
                <p className="text-white mt-2 text-xs text-center md:text-sm" style={{ fontFamily: "verdana" }}>Select livestock to monitor and keep track of pregnancy</p>
                ...
                <div className="mx-auto mt-12 md:mt-36" >
                    ...
                    <div className="grid grid-cols-1 w-11/12 gap-8 mx-auto md:grid-cols-2 md:gap-16 md:w-4/5">
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/pregnancychecker/goat`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Goat</h1>
                                    <div style={{marginTop:"-28px"}}>
                                        <Image
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/pregnancychecker/pig`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Pig</h1>
                                    <div  style={{marginTop:"-28px"}}>
                                        <Image
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/pregnancychecker/sheep`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Sheep</h1>
                                    <div  style={{marginTop:"-28px"}}>
                                        <Image
