  ...
  return (
    ...
    <div className="dashboard-main">
      ...
      <div className="">
        <div className="up">
          <div>
            <h1 className="module-header md:mt-12 mt-0 ">Livestock Profile (Cattle)</h1>
            ...
            {livestockData.map((row, key) => (
              ...
              >
                <td className="w-full md:w-auto flex justify-between items-center p-3 text-gray-800 text-center border border-b  block md:table-cell relative md:static">
                  <span className="md:hidden  top-0 left-0 rounded-none  px-2 py-1  font-bold uppercase" style={{ backgroundColor: "#63ee6c",color:"#01000D", fontSize: "11px" }}>
                    ID
                  </span>
      ...
      {//Livestock input form
        ...
        formModal && <div className="form-backdrop" class=" py-12 bg-white transition overflow-y-auto  duration-150 ease-in-out z-10 absolute  top-0 right-0 bottom-0 left-0" id="modal">
          <p className="form-header pt-10 md:pt-0">Livestock Profile Details</p>
