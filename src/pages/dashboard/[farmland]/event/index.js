...
function LivestockSelection() {
  ...
  return (
    <div>
      <Head>
        <title>druminant - event profile</title>
            ...
            <div className="mx-auto mt-12 md:mt-36">
              <div className="grid grid-cols-1 w-11/12 gap-8 mx-auto md:grid-cols-2 md:gap-16 md:w-4/5">
                <div className="card4 transform duration-1000    hover:scale-105 hover:animate-pulse">
                  <Link href={`/dashboard/${userData?.farmland}/event/cattle`}>
                ...
                <div className="card4 transform duration-1000  hover:scale-105 hover:animate-pulse">
                  <Link href={`/dashboard/${userData?.farmland}/event/goat`}>
                    <div className="flex justify-between mt-10">
                      <h1>Goat</h1>
                      <div style={{ marginTop: "-28px" }}>
                        <Image
                ...
                <div className="card4 transform duration-1000  hover:scale-105 hover:animate-pulse">
                  <Link href={`/dashboard/${userData?.farmland}/event/pig`}>
                    <div className="flex justify-between mt-10">
                      <h1>Pig</h1>
                      <div style={{ marginTop: "-28px" }}>
                        <Image
                ...
                <div className="card4 transform duration-1000  hover:scale-105 hover:animate-pulse">
                  <Link href={`/dashboard/${userData?.farmland}/event/sheep`}>
                    <div className="flex justify-between mt-10">
                      <h1>Sheep</h1>
                      <div style={{ marginTop: "-28px" }}>
                        <Image
