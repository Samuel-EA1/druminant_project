...
function FinanceRecord() {
  ...
  function editBtnFn(id) {
    ...
    seteditform({
      ...
      transactionDate: formatDateTimeLocal(selectedRecord.transactionDate),
        ...
        >
          ...
          <div className={`finance-cards `}>
            <div className="incomeCard flex" style={getActiveStyle("income")}>
              ...
              <div className=" mr-2    flex flex-col justify-center space-y-2 sm:flex-row sm:space-y-0 space-x-3 items-center  mt-2">
                <button
                      ...
                      {creating ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            role="button"
                          >
                            <IoMdClose type="button" onClick={closeFormModal} />
                          </button>
                        </>
                      )}
                    </form>
              ...
              <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                ...
                <div class="grid grid-cols-2 gap-4 px-1 w-full">
                  <div class="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                    ...
                    <p
                      class="text-base  first-letter:capitalize font-medium text-navy-700 dark:text-green-700"
                  ...
                  <div class="flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                    ...
                    <p class="text-base first-letter:capitalize  font-medium text-navy-700 dark:text-green-700">
                      N{selected.amount}
                    </p>
                  </div>
