...
export default function Quarantine() {
  ...
  const handleRelease = async () => {
    ...
    try {
      const res = await axios.post(
        ` ${BASE_URL}/farmland/${userData.farmland}/livestock/sheep/${quarantinTagId}`,
        quarantinFormData,
        {
          headers: {
  ...
  return (
    ...
    >
      <Head>
        <title>Druminant - quarantine Profile (Sheep)</title>
        ...
        {viewquarantine && (
          <div className="fixed inset-0 flex  items-center justify-center bg-gray-800 bg-opacity-50 z-50">
            ...
            >
              ...
              <div className="grid grid-cols-2  grid-rows-1 gap-1 px-1 w-full">
...

      {
        ...
        quarantineModal && (
          <div
            className="form-backdrop py-12 bg-[#01000D]    transition duration-150 ease-in-out z-10 absolute inset-0"
            id="modal"
          >
            <div
              role="alert"
              className="container mx-auto w-11/12 md:w-2/3 max-w-xl  mt-36"
            >
