...
export default function Lactation() {
  ...
  return (
    <div className="livestock">
      <Head>
        <title>Druminant - Lactation Tracker (sheep)</title>
      ...
      <div className="p-2 md:p-5    ">
        ...
        <div className={`md:mt-10 ${(editFormModal || formModal) && "hidden"}`}>
          {userData?.token && (
            <div className=" ">
              <div>
                <h1 className="text-lg md:text-2xl head  font-bold">Lactation Tracker (Sheep)</h1>
        ...
        {userData?.token && !fetchError ? (
          <div
            className={`flex  flex-col justify-between min-h-screen ${(editFormModal || formModal) && "hidden"
              }`}
          >
