...
export default function Lactation() {
  ...
  return (
    <div className="livestock">
      <Head>
        <title>Druminant - Lactation Tracker (pig)</title>
      ...
      <div className="p-2 md:p-5    ">
        ...
        <div className={`md:mt-10 ${(editFormModal || formModal) && "hidden"}`}>
          {userData?.token && (
            <div className=" ">
              <div>
                <h1 className="text-lg md:text-2xl head  font-bold">Lactation Tracker (Pig)</h1>
                <p className=" mt-1">Keep track of livestock lactation records</p>
              </div>
...
{ViewLactation && (
        <div className="fixed inset-0 flex  items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          ...
          >
            ...
            <div className="flex  justify-between mt-8 max-w-lg  space-x-2   rounded-2xl bg-white bg-clip-border  shadow-3xl shadow-shadow-500  "
