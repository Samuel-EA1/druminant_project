...
export default function Livestock() {
  ...
  return (
    <div className="livestock">
      <Head>
        <title>Druminant - Pregnancy Checker (Pig)</title>
      ...
      <div className="relative">
        ...
        <div>
          <div className="up">
            <div>
              <h1 className="module-header">Lactation Tracker (Pig)</h1>
          ...
          <div className="add-search-div">
            <div className="cursor">
              <p className="add-btn3" onClick={() => setFormModal(!formModal)}><span><MdAdd style={{marginTop: "4px", color: "white" }}/> </span> Add Record</p>
            </div>
