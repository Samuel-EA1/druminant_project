          ...
          {userData?.token && !formModal && (
            <div className="  ">
              <div>
                ...
                <p className=" mt-1">
                  Monitor expected lambing date (ELD) in your livestock
                </p>
              </div>
              <AddSearchComponent
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 px-1 w-full">
              <div className="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                ...
                <p className="text-base font-medium first-letter:capitalize text-navy-700    sm:w-full  dark:text-green-700" 
