        ...
        <div className=" md:mt-10 ">
          {userData?.token && (
            <div className=" flex flex-col  h-fit py-2 space-y-2  ">
              <div>
                <h1 className="text-2xl  font-bold">Pregnancy Profile (PIG)</h1>
                ...
                <tbody>
                  {pregnancyData.map((row, key) => (
                    ...
                    >
                      ...
                      <td className="w-full md:w-auto space-x-2   justify-between items-center p-3 text-gray-800 text-center border border-b text-center block md:table-cell relative md:static">
                        <span
                          className="md:hidden w-28  top-0 left-0 rounded-md  px-2 py-1  font-bold uppercase"
                          style={{
                            backgroundColor: "#9be49b",
