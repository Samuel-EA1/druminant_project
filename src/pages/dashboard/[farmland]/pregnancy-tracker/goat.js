...
export default function PregnancyTracker() {
  ...
  //      breedingDate: formatDateTimeLocal(selectedRecord.eventDate),
  ...
  function editBtnFn(id) {
    ...
    setEditFormInput({
      tagId: selectedRecord.tagId,
      breedingDate: formatDateTimeLocal(selectedRecord.breedingDate),
      breed: selectedRecord.breed,
  ...
  //  work on pregnancy tracker now

  return (
    <div className=" livestock" ref={tableRef}>
      <Head>
        <title>Druminant - pregnancy Profile (Goat)</title>
            ...
            <div className="  ">
              <div>
                <h1 className="text-lg md:text-2xl head font-bold">
                  Pregnancy Tracker (Goat)
                </h1>
                <p className=" mt-1">
                  Monitor expected kidding date (EKD) in your livestock
                </p>
              </div>
              <AddSearchComponent
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 px-1 w-full">
              <div className="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                ...
                <p className="text-base font-medium text-navy-700  first-letter:capitalize  sm:w-full  dark:text-green-700" style={{width:"100%", overflow:"auto"}}>
                  {selected.tagId}
                </p>
              </div>
              ...
              <div className="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                ...
                <p className="text-base font-medium  first-letter:capitalize text-navy-700 dark:text-green-700  w-32 sm:w-full "
                style={{overflow:"auto"}}>
                  {selected.breed}
                </p>
              </div>
              <div className="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                ...
                <p className="text-base font-medium text-navy-700 first-letter:capitalize dark:text-green-700">
                  {selected.status}
                </p>
              </div>
