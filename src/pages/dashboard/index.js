                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {livestockCount.length ? (
                                <strong>
                                  {
                                    livestockCount.find((e) => e.name === "pig")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {incomeCount.length ? (
                                <strong>
                                  {
                                    incomeCount.find((e) => e.name === "cattle")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {incomeCount.length ? (
                                <strong>
                                  {
                                    incomeCount.find((e) => e.name === "goat")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                              ...
                              {expenseCount.length ? (
                                <strong>
                                  {
                                    expenseCount.find((e) => e.name === "goat")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {expenseCount.length ? (
                                <strong>
                                  {
                                    expenseCount.find((e) => e.name === "pig")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {incomeCount.length ? (
                                <strong>
                                  {
                                    incomeCount.find((e) => e.name === "sheep")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                              ...
                              {expenseCount.length ? (
                                <strong>
                                  {
                                    expenseCount.find((e) => e.name === "sheep")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {eventCount.length ? (
                                <strong>
                                  {
                                    eventCount.find((e) => e.name === "cattle")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {eventCount.length ? (
                                <strong>
                                  {
                                    eventCount.find((e) => e.name === "sheep")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {pregnancyCount.length ? (
                                <strong>
                                  {
                                    pregnancyCount.find((e) => e.name === "pig")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                          ...
                          <div className="flex items-center   space-x-2">
                            ...
                            <p className="font-semibold">
                              ...
                              {lactationCount.length ? (
                                <strong>
                                  {
                                    lactationCount.find((e) => e.name === "pig")
                                      ?.data
                                  }
                                </strong>
                              ) : (
                ...
                <div className="p-2 basis-80 lg:basis-96 md:m-5  ">
                  <Link href={`/dashboard/quarantine`}>
                    <div className="bg-gray-200 w-full p-3   rounded-md  max-w-md lg:max-w-sm mx-auto transform duration-1000 hover:scale-105 hover:animate-pulse ">
                      <div className="flex items-center">
                        {/* <FaCow style={{ fontSize: "25px", marginTop: "10px", marginLeft: "5px", color: "#030025" }} /> */}
                        <h1 className="font-bold text-lg mb-2">Quarantine</h1>
                      </div>
