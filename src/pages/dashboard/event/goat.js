...
export default function Livestock() {
  ...
  return (
    <div className="livestock">
      <Head>
        <title>Druminant - Event Tracker (Goat)</title>
      ...
      <div className="relative">
        ...
        <div>
          <div className="up">
            <div>
              <h1 className="module-header">Event Tracker (Goat)</h1>
          ...
          <div className="add-search-div">
            <div className="cursor">
              <p className="add-btn" onClick={addEvent}><span>+ </span> Add Event</p>
            </div>
        ...
        {//Livestock input form
          ...
          formModal && <div className="form-backdrop" class=" py-12 bg-[#01000D] overflow-y-auto h-screen  transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
            <p className="form-header pt-10 pb:0 md:pt-0">Event Details</p>
        ...
        {//Livestock EDIT form
          ...
          editFormModal && <div className="form-backdrop" class=" py-12 bg-[#01000D] overflow-y-auto h-screen  transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
            <p className="form-header pt-10 pb:0 md:pt-0">Edit Event Details</p>
