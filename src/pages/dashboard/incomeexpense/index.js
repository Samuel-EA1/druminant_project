...
function LivestockSelection() {
    ...
    return <div>
        <Head>
            <title>druminant - Income/Expense</title>
        ...
        <div>
            ...
            <div className="dashboard-main  mx-auto">
                <h1 className=" text-white mt-5 text-center md:mt-16" style={{ fontFamily: "verdana", fontWeight: "bold", fontSize: "17px" }}>Income/Expense Manangement</h1>
                <p className="text-white mt-2 text-xs text-center md:text-sm" style={{ fontFamily: "verdana" }}>Select livestock to monitor and record related finances</p>
                ...
                <div className="mx-auto mt-12 md:mt-36" >
                    ...
                    <div className="grid grid-cols-1 w-11/12 gap-8 mx-auto md:grid-cols-2 md:gap-16 md:w-4/5">
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/incomeexpense/goat`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Goat</h1>
                                    <div style={{marginTop:"-28px"}}>
                                        <Image
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/incomeexpense/pig`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Pig</h1>
                                    <div  style={{marginTop:"-28px"}}>
                                        <Image
                        ...
                        <div className="card4 hover:scale-105 hover:animate-pulse">
                            <Link href={`/dashboard/incomeexpense/sheep`}>
                                <div className="flex justify-between mt-10">
                                    <h1>Sheep</h1>
                                    <div  style={{marginTop:"-28px"}}>
                                        <Image
